...
%% with NO author name or year ever printed inline, regardless of
%% elsarticle's own internal (and unconfigured, since no .bst/BibTeX
%% run happens here) natbib defaults. This is what makes every citation
%% command used below render as a plain number.
