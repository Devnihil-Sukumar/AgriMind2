...
|---|---|---|---|---|---|
| WeatherAgent | 10 | 0 | 0 | 1.0 | 1.0 |
| SoilAgent | 10 | 0 | 0 | 1.0 | 1.0 |
| SatelliteAgent | 10 | 0 | 0 | 1.0 | 1.0 |
| MarketAgent | 5 | 0 | 0 | 1.0 | 1.0 |
| HistoricalAgent | 0 | 0 | 0 | N/A | N/A |

## Table 2: Individual Agent Evaluation
| Agent | Accuracy | Precision | Recall | F1 | Avg Latency | Failure Rate |
|---|---|---|---|---|---|---|
| WeatherAgent | 1.0 | 1.0 | 1.0 | 1.0 | 195.78s | 0.0% |
| SoilAgent | 1.0 | 1.0 | 1.0 | 1.0 | 280.97s | 0.0% |
| SatelliteAgent | 1.0 | 1.0 | 1.0 | 1.0 | 61.33s | 0.0% |
| MarketAgent | 1.0 | 1.0 | 1.0 | 1.0 | 61.81s | 0.0% |
| HistoricalAgent | N/A | N/A | N/A | N/A | N/A | N/A |
...
|---|---|---|---|---|
| 1. Single-agent baseline | 0.0% (N=0) | 0.0% | N/A | N/A |
| 2. Multi-agent, no collaborative reasoning | 0.0% (N=0) | 0.0% | N/A | N/A |
| 3. Multi-agent + collaborative reasoning | 0.0% (N=0) | 0.0% | N/A | N/A |
| 4. Full AgriMind + TRUSTAI | 100.0% (N=11) | 63.64% | 3.691 | 430.34s |
...
- N=50 is small; all proportions are reported with Wilson 95% confidence intervals rather than bare point estimates.
